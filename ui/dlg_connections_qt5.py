...
class Ui_DlgConnections(object):
    def setupUi(self, DlgConnections):
        ...
        self.tabTrexCache = QtWidgets.QWidget()
        self.tabTrexCache.setObjectName("tabTrexCache")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.tabTrexCache)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblSource_2 = QtWidgets.QLabel(self.tabTrexCache)
        self.lblSource_2.setObjectName("lblSource_2")
        self.horizontalLayout_2.addWidget(self.lblSource_2)
        self.txtTrexCachePath = QtWidgets.QLineEdit(self.tabTrexCache)
        self.txtTrexCachePath.setText("")
        self.txtTrexCachePath.setPlaceholderText("")
        self.txtTrexCachePath.setObjectName("txtTrexCachePath")
        self.horizontalLayout_2.addWidget(self.txtTrexCachePath)
        self.btnBrowseTrexCache = QtWidgets.QPushButton(self.tabTrexCache)
        self.btnBrowseTrexCache.setObjectName("btnBrowseTrexCache")
        self.horizontalLayout_2.addWidget(self.btnBrowseTrexCache)
        self.tabConnections.addTab(self.tabTrexCache, "")
    ...
    def retranslateUi(self, DlgConnections):
        ...
        self.txtTrexCachePath.setToolTip(_translate("DlgConnections", "The URL to the TileJSON of the tile service (e.g. http://yourtilehoster.com/index.json)"))
        self.btnBrowseTrexCache.setText(_translate("DlgConnections", "Browse"))
        self.tabConnections.setTabText(self.tabConnections.indexOf(self.tabTrexCache), _translate("DlgConnections", "Directory"))
