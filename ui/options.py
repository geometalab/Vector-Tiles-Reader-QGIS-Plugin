...
class Ui_OptionsGroup(object):
    def setupUi(self, OptionsGroup):
        ...
        self.gridLayout.addWidget(self.rbZoomMax, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.rbZoomAuto, 5, 1, 1, 1)
        ...
        self.chkAutoLoadTiles.setChecked(True)
    ...
    def retranslateUi(self, OptionsGroup):
        ...
        self.chkAutoLoadTiles.setText(_translate("OptionsGroup", "Automaticallyy load tiles for visible area", None))
