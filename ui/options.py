...
class Ui_OptionsGroup(object):
    def setupUi(self, OptionsGroup):
        ...
        self.gridLayout.addLayout(self.horizontalLayout_3, 12, 0, 1, 2)
        self.chkClipTiles = QtGui.QCheckBox(OptionsGroup)
        self.chkClipTiles.setObjectName(_fromUtf8("chkClipTiles"))
        self.gridLayout.addWidget(self.chkClipTiles, 5, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.chkApplyStyles, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.rbAutoZoom, 7, 1, 1, 1)
