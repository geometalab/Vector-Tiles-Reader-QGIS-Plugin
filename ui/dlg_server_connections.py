...
class Ui_DlgServerConnections(object):
    def setupUi(self, DlgServerConnections):
        ...
        DlgServerConnections.resize(922, 671)
        ...
        self.chkMergeTiles = QtGui.QCheckBox(self.groupBox_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chkMergeTiles.sizePolicy().hasHeightForWidth())
        self.chkMergeTiles.setSizePolicy(sizePolicy)
        self.chkMergeTiles.setChecked(False)
        self.chkMergeTiles.setObjectName(_fromUtf8("chkMergeTiles"))
        self.verticalLayout.addWidget(self.chkMergeTiles)
        self.chkApplyStyles = QtGui.QCheckBox(self.groupBox_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chkApplyStyles.sizePolicy().hasHeightForWidth())
        self.chkApplyStyles.setSizePolicy(sizePolicy)
        self.chkApplyStyles.setChecked(True)
        self.chkApplyStyles.setObjectName(_fromUtf8("chkApplyStyles"))
        self.verticalLayout.addWidget(self.chkApplyStyles)
        ...
        self.checkBox = QtGui.QCheckBox(DlgServerConnections)
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.horizontalLayout.addWidget(self.checkBox, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, DlgServerConnections):
        ...
        self.chkApplyStyles.setText(_translate("DlgServerConnections", "Apply default styles for OpenMapTiles (disable for performance)", None))
