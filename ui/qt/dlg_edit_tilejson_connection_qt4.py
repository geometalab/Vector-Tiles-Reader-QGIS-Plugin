...
# Form implementation generated from reading ui file 'qt/dlg_edit_tilejson_connection.ui'
#
...
class Ui_DlgEditTileJSONConnection(object):
    ...
    def retranslateUi(self, DlgEditTileJSONConnection):
        ...
        self.lblServerStyleJsonUrl.setText(_translate("DlgEditTileJSONConnection", "GL Style JSON URL", None))
