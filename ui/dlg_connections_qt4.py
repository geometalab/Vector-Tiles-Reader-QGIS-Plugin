...
class Ui_DlgConnections(object):
    ...
    def retranslateUi(self, DlgConnections):
        ...
        self.lblMbtilesStyleJsonUrl.setText(_translate("DlgConnections", "StyleJSON URL", None))
        ...
        self.lblDirectoryStyleJsonUrl.setText(_translate("DlgConnections", "StyleJSON URL", None))
