...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="e3273a18-0065-4c94-a4ad-d9fa7f0d7823">
      <rule description="building" key="{895a87ed-903b-458d-b872-130b7d9496d9}" symbol="0" label="building"/>
      <rule description="building-top" key="{618b725e-e011-41f5-83b5-454de2f2aee3}" symbol="1" label="building-top"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color_border_dd_expression" v="'#112233'"/>
          <prop k="color_border_dd_field" v=""/>
          <prop k="color_border_dd_useexpr" v="1"/>
          <prop k="color_dd_active" v="1"/>
          <prop k="color_dd_expression" v="if (25000 &lt; @map_scale &lt;= 10000000000, '#f2eae2', if (12500 &lt; @map_scale &lt;= 25000, '#f2eae2', if (100 &lt; @map_scale &lt;= 12500, '#dfdbd7', '#dfdbd7')))"/>
          ...
          <prop k="outline_color_dd_active" v="1"/>
          <prop k="outline_color_dd_expression" v="if (25000 &lt; @map_scale &lt;= 10000000000, '#f2eae2', if (12500 &lt; @map_scale &lt;= 25000, '#f2eae2', if (100 &lt; @map_scale &lt;= 12500, '#dfdbd7', '#dfdbd7')))"/>
          <prop k="outline_color_dd_field" v=""/>
          <prop k="outline_color_dd_useexpr" v="1"/>
      ...
      <symbol alpha="0" clip_to_extent="1" type="fill" name="1">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="0,0,0,255"/>
          <prop k="color_dd_active" v="1"/>
          <prop k="color_dd_expression" v="#f2eae2"/>
          <prop k="color_dd_field" v=""/>
          <prop k="color_dd_useexpr" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          ...
          <prop k="outline_color" v="0,0,0,255"/>
          <prop k="outline_color_dd_active" v="1"/>
          <prop k="outline_color_dd_expression" v="#dfdbd7"/>
          <prop k="outline_color_dd_field" v=""/>
          <prop k="outline_color_dd_useexpr" v="1"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.7"/>
  ...
  <labeling type="rule-based">
    <rules key="{a3f7360f-28be-455b-8f25-8ef6a665a0d8}"/>
  </labeling>
  <customproperties>
  ...
  <aliases>
    <alias field="render_min_height" index="0" name=""/>
    <alias field="render_height" index="1" name=""/>
  </aliases>
