...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="name:ka">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="name:he">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="name:uk">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="name:et">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="name:ca">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 type="nullSymbol"/>
  <labeling type="rule-based">
    <rules key="{8492846d-7989-46e2-a15f-46f620097907}">
      <rule description="water-name-lakeline" key="{4657a6b7-d7ee-471c-82f6-1ca7e355c1f6}">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="116,174,233,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="&quot;name&quot;" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <text-buffer bufferSize="1.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,179" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="1" bufferNoFill="0" bufferJoinStyle="128"/>
      ...
      <rule description="water-name-ocean" filter="&quot;class&quot; is not null and &quot;class&quot; = 'ocean'" key="{afc52168-e68e-4d50-8809-fbbb1177ee92}">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="116,174,233,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="10" fieldName="&quot;name&quot;" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
      ...
      <rule scalemaxdenom="1000000000" description="water-name-other-zoom-0" filter="(&quot;class&quot; is null or &quot;class&quot; not in ('ocean'))" key="{69ae7739-4e48-4b87-8ead-967c13028651}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="116,174,233,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12" fieldName="&quot;name&quot;" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          <text-format placeDirectionSymbol="0" multilineAlign="4294967295" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
          <text-buffer bufferSize="1.5" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,179" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="1" bufferNoFill="0" bufferJoinStyle="128"/>
          ...
          <rendering fontMinPixelSize="3" scaleMax="10000000" fontMaxPixelSize="10000" scaleMin="1" upsidedownLabels="0" limitNumLabels="0" obstacle="1" obstacleFactor="1" scaleVisibility="0" fontLimitPixelSize="0" mergeLines="1" obstacleType="0" labelPerPart="0" zIndex="0" maxNumLabels="2000" displayAll="0" minFeatureSize="0"/>
          <data-defined>
            <Size expr="interpolate_exp(get_zoom_for_scale(@map_scale), 1, 0, 6, 10, 14) / 96*72" field="" active="true" useExpr="true"/>
          </data-defined>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="VectorTilesReader/layerStyle" value="c:\users\martin\appdata\local\temp\vector_tiles_reader\styles\OpenMapTiles.com (with custom key)\water_name.qml"/>
  ...
  <aliases>
    ...
    <alias field="name:latin" index="6" name=""/>
    <alias field="name_en" index="7" name=""/>
    <alias field="class" index="8" name=""/>
    <alias field="name:en" index="9" name=""/>
    <alias field="name:ka" index="10" name=""/>
    <alias field="name:he" index="11" name=""/>
    <alias field="name:cs" index="12" name=""/>
    <alias field="name:de" index="13" name=""/>
    <alias field="name:fr" index="14" name=""/>
    <alias field="name:uk" index="15" name=""/>
    <alias field="name:et" index="16" name=""/>
    <alias field="name:zh" index="17" name=""/>
    <alias field="name:pl" index="18" name=""/>
    <alias field="name:ca" index="19" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="name:ka"/>
      <column width="-1" hidden="0" type="field" name="name:he"/>
      ...
      <column width="-1" hidden="0" type="field" name="name:uk"/>
      <column width="-1" hidden="0" type="field" name="name:et"/>
      <column width="-1" hidden="0" type="field" name="name:zh"/>
      <column width="-1" hidden="0" type="field" name="name:pl"/>
      <column width="-1" hidden="0" type="field" name="name:ca"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="name:ka" expression=""/>
    <default field="name:he" expression=""/>
    <default field="name:cs" expression=""/>
    <default field="name:de" expression=""/>
    <default field="name:fr" expression=""/>
    <default field="name:uk" expression=""/>
    <default field="name:et" expression=""/>
    <default field="name:zh" expression=""/>
    <default field="name:pl" expression=""/>
    <default field="name:ca" expression=""/>
  </defaults>
