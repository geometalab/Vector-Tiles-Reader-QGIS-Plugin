...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{3bba49cd-21a7-4efe-9ba2-96cf3f740477}">
      <rule filter=" &quot;myfield&quot; = 'hello world'" key="{b7c32926-4c6b-469b-b63d-6034bf04397b}" symbol="0" label="test"/>
      <rule filter="&quot;myfield2&quot; = 'second value'" key="{345b0d42-510f-4d13-bf78-073fec5ef891}" symbol="1" label="test2"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="160,231,218,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="vector_tile_source" value="C:/Users/boosm/.qgis2/python/plugins/Vector-Tiles-Reader-QGIS-Plugin/sample_data/uster_zh.mbtiles"/>
