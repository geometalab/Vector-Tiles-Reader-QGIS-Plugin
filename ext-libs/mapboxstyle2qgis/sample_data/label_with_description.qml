...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="cb32d839-4e91-49f0-875c-d331f3960980"/>
    <symbols/>
  </renderer-v2>
  <labeling type="rule-based">
    <rules key="{192e8266-8d01-46c3-bcb4-1951cecbdaf9}">
      <rule description="rule description" filter="1=1" key="{28d4e85a-8ef2-4376-9313-2f3df0796dc9}">
        <settings>
  ...
  <customproperties>
    ...
    <property key="layerStyle" value="C:\Users\Martin\.qgis2\python\plugins\vector_tiles_reader\styles/transportation_name.qml"/>
  ...
  <aliases>
    ...
    <alias field="_id" index="8" name=""/>
    <alias field="class" index="9" name=""/>
    <alias field="ref_length" index="10" name=""/>
    <alias field="ref" index="11" name=""/>
    <alias field="network" index="12" name=""/>
  </aliases>
