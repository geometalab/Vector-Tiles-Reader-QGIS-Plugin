...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="7ab1a862-fc22-4682-af65-ff63c86ba04f">
      <rule scalemaxdenom="50000000" description="road_path-zoom-4" filter="((&quot;class&quot; is not null and &quot;class&quot; in ('path', 'track')))" key="{fd28c144-faae-4863-b5c0-3e03b3ab6c3d}" symbol="0" scalemindenom="750" label="road_path-zoom-4"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="0.25;0.5"/>
          ...
          <prop k="width_dd_expression" v="1/@map_scale*10000"/>
  ...
  <labeling type="rule-based">
    <rules key="{fe4574c6-c866-405a-acf4-db16b684940b}"/>
  </labeling>
  <customproperties>
