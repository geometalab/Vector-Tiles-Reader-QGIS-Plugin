...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name_dd_expression" v="'C:/Users/Martin/Downloads/icons/'+ &quot;class&quot; + '-11.svg'"/>
  ...
  <labeling type="rule-based">
    <rules key="{6a1bc2a6-232c-417c-8fd9-7c18a88badfc}">
      <rule scalemaxdenom="12500" description="poi-level-3-zoom-16" key="{010f8581-62f8-47b4-9b9a-4635c4e9c1bc}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="102,102,102,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="9" fieldName="name:latin" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
  ...
  <customproperties>
    ...
    <property key="VectorTilesReader/layerStyle" value="C:/Users/Martin/.qgis2/python/plugins\vector_tiles_reader\util\..\styles/poi.qml"/>
  ...
  <aliases>
    ...
    <alias field="subclass" index="6" name=""/>
    ...
    <alias field="name:de" index="11" name=""/>
    <alias field="name:en" index="12" name=""/>
    <alias field="name:pl" index="13" name=""/>
  </aliases>
