...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <labeling type="rule-based">
    <rules key="{86087496-ca99-44ba-b680-586693005f6c}">
      <rule scalemaxdenom="750000" description="road_major_label-zoom-10" key="{248d4a55-a664-4c48-b9e9-8aa8bb5adbca}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="12" fieldName="name" namedStyle="Normal" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
          ...
          <text-buffer bufferSize="2" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="1" bufferNoFill="0" bufferJoinStyle="128"/>
          ...
          <data-defined>
            <Size expr="interpolate_exp(get_zoom_for_scale(@map_scale), 1.4, 10, 20, 8, 14) / 96*72" field="" active="true" useExpr="true"/>
          </data-defined>
        </settings>
      </rule>
    </rules>
  ...
  <customproperties>
    ...
    <property key="VectorTilesReader/layerStyle" value="c:\users\martin\appdata\local\temp\vector_tiles_reader\styles\OpenMapTiles.com (with custom key)\transportation_name.qml"/>
  ...
  <aliases>
    ...
    <alias field="ref_length" index="9" name=""/>
    <alias field="ref" index="10" name=""/>
    <alias field="network" index="11" name=""/>
  </aliases>
