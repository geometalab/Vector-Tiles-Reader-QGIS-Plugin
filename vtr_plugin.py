...
class VtrPlugin:
    ...
    def _has_extent_changed(self) -> Tuple[bool, BOUNDS_TYPE]:
    ...
    def _get_visible_extent_as_tile_bounds(self, zoom: int):
        ...
        tile_bounds = get_tile_bounds(zoom, bounds=bounds, scheme=scheme, source_crs=str(source_crs))
        return tile_bounds
