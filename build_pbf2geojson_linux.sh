...
g++ -m32 -std=c++11 -Iinclude -I../protozero/include -I../vtzero/include -s -Os -Ofast -O3 --shared -fPIC -o ./ext-libs/pbf2geojson/pbf2geojson_i686.so ./ext-libs/pbf2geojson/pbf2geojson.cpp
