...
<qgis version="2.18.4" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="outline_color" v="176,199,144,255"/>
  ...
  <displayfield>zoomLevel</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="zoomLevel" index="0" name=""/>
    <alias field="row" index="1" name=""/>
    <alias field="featureNr" index="2" name=""/>
    <alias field="class" index="3" name=""/>
    <alias field="col" index="4" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-731515136">
    <columns>
