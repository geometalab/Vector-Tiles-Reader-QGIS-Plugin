...
<qgis version="2.18.6" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{7904be7e-c5a0-48fe-b779-5d7891204c47}">
      <rule filter="&quot;class&quot; = 'allotments'" key="{7673db48-e87d-4575-9671-e93ec2acfcf6}" symbol="0" label="allotments"/>
      <rule filter="&quot;class&quot; = 'farm'" key="{a96ea9d5-da32-4d26-897f-7fc67b963d84}" symbol="1" label="farm"/>
      <rule filter="&quot;class&quot; = 'farmland'" key="{9f290643-0360-4a33-b83f-2b48c06c7c17}" symbol="2" label="farmland"/>
      <rule filter="&quot;class&quot; = 'orchard'" key="{6fcc8d58-af34-42d3-9cb3-c5fa01dc4214}" symbol="3" label="orchard"/>
      <rule filter="&quot;class&quot; = 'plant_nursery'" key="{77d035d7-55db-4cbd-8150-a0022d2826e3}" symbol="4" label="plant_nursery"/>
      <rule filter="&quot;class&quot; = 'vineyard'" key="{182eb501-5bf1-445e-a61c-8398dd9d8368}" symbol="5" label="vineyard"/>
      ...
      <rule filter="&quot;class&quot; = 'wet_meadow'" key="{97ad4c6f-a554-4f35-9c5e-69aae52e3c77}" symbol="16" label="wet_meadow"/>
      <rule filter="&quot;class&quot; = 'marsh'" key="{4da36205-aa53-40ac-ac35-4c26f92b9c35}" symbol="17" label="marsh"/>
      <rule filter="&quot;class&quot; = 'reedbed'" key="{38454a62-100c-4b5e-a1fa-390e00320385}" symbol="18" label="reedbed"/>
      <rule filter="&quot;class&quot; = 'saltern'" key="{002c3292-b553-4bb4-a454-925069da211c}" symbol="19" label="saltern"/>
      <rule filter="&quot;class&quot; = 'tidalflat'" key="{f4514a4d-6c77-4227-94e0-8df7a07dbf25}" symbol="20" label="tidalflat"/>
      <rule filter="&quot;class&quot; = 'saltmarsh'" key="{6df3ebce-4232-46af-853b-8e02df38ee47}" symbol="21" label="saltmarsh"/>
      <rule filter="&quot;class&quot; = 'mangrove'" key="{f1a6e548-6aa8-43a6-82e9-14ed29dc8628}" symbol="22" label="mangrove"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@13@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="line"/>
              <prop k="offset" v="0.00000000000000006,1.79999999999999982"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="67,154,229,255"/>
              <prop k="outline_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="174,223,163,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
        ...
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@3@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="117,158,108,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-2147483648">
    <columns>
